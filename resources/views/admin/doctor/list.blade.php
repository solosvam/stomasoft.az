            ...
            <div class="col">
                ...
                <div class="data-table-rows slim">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-5 col-lg-3 col-xxl-2 mb-1">
                            <div class="d-inline-block float-md-start me-1 mb-1 search-input-container w-100 shadow bg-foreground">
                                <input class="form-control datatable-search" placeholder="{{ __('search') }}" data-datatable="#doctorsAjaxTable" />
                        ...
                        <div class="col-sm-12 col-md-7 col-lg-9 col-xxl-10 text-end mb-1">
                            <div class="d-inline-block">
                                ...
                                <button
                                    ...
                                    data-bs-delay="0"
                                    data-datatable="#doctorsAjaxTable"
                                ...
                                <div class="d-inline-block datatable-export" data-datatable="#doctorsAjaxTable">
                                ...
                                <!-- Length Start -->
                                <div class="dropdown-as-select d-inline-block datatable-length" data-datatable="#doctorsAjaxTable" data-childSelector="span">
                    ...
                    <div class="data-table-responsive-wrapper">
                        <table id="doctorsAjaxTable" class="data-table nowrap w-100">
                            <thead>
                            <tr>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">{{ __('new_doctor_btn') }}</h5>
