                            ...
                            <table class="data-table data-table-pagination data-table-standard responsive nowrap hover" id="datatableHover" data-order='[[ 0, "asc" ]]'>
                                ...
                                @foreach($debtors as $debtor)
                                    <tr>
                                        ...
                                        <td class="text-alternate">{{$debtor->mobile}}</td>
                                        <td class="text-alternate">{{$debtor->balance->balance}} AZN</td>
                                        <td class="text-alternate">
                                            <a href="{{route('admin.tcrm.info',$debtor->id)}}" class="btn btn-primary btn-sm">{{ __('menu_crm') }}</a>
                                        </td>
                                    </tr>
                                @endforeach
                                </tbody>
