@php
    $html_tag_data = [];
    $title = __('role_edit');
    $breadcrumbs = ["/admin"=>"White Dent", ""=>__('role_edit')];
@endphp
        ...
        <div class="row">
            <div class="col">
                <section class="scroll-section" id="userButtons">
                    <h2 class="small-title">{{ __('role_edit') }}</h2>
                    <div class="card h-100-card">
                        <div class="card-body">
                            <form action="{{route('admin.role.update',$role->id)}}" method="post">
                                ...
                                <div class="mb-3 row">
                                    <label class="col-lg-2 col-md-3 col-sm-4 col-form-label">{{ __('description') }}</label>
                                    <div class="col-sm-8 col-md-9 col-lg-10">
